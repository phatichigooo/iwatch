            ...
            <div className="row">
                ...
                <div className=" categories col-xs-3 col-sm-3 col-md-3 col-lg-3">
                    ...
                    <div className="title">
                      ...
                      {/*Radio group*/}
                        <div className="form-check">
                            <input className="form-check-input with-gap" name="group101" type="radio" id="radio100" />
                            <label className="form-check-label" htmlFor="radio100">Male</label>
                        </div>
                        <div className="form-check">
                            <input className="form-check-input with-gap" name="group101" type="radio" id="radio101" defaultChecked />
                            <label className="form-check-label" htmlFor="radio101">Female </label>
                        </div>
                        {/*Radio group*/}
                      <div className="radio">
